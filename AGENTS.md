...
- The server listens on `https://127.0.0.1:8443` (HTTPS only). On first run it auto-generates config and a self-signed ECDSA P-256 cert under `~/.config/fileapi/` (Linux). No setup step is needed for this.
